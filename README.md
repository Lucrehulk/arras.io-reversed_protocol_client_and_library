...
Also, yes I am aware there are some odd things about the client like text boxes being bugged, this was my own personal client which I utilized for reverse engineering purposes as mentioned before. I tinkered with a lot of things within the client and so there may be some odd things like that.
